# Imágenes de Planes y Precios

Este directorio contiene las imágenes para los planes de precios.

## Archivos necesarios:

- `plan1.jpg` - Imagen para el Plan Básico
- `plan2.jpg` - Imagen para el Plan Estándar  
- `plan3.jpg` - Imagen para el Plan Premium
